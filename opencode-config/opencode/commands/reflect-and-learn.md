...
- note the lessons for current project via semantika write_memory, in project AGENTS.md or module AGENTS-xxx.md
- note the global lessons in ~/.config/opencode/AGENTS.md

NOTE: When writing to AGENTS.md:
  - bad : append lessons directly at bottom of file
